...
public class RGSTest {
    ...
    public void rgsTest() {
        ...
        Assert.assertEquals("Заголовок не совпадает", "Добровольное медицинское страхование", driver.findElement(By.xpath("//h1")).getText());
        ...
        Assert.assertTrue(driver.getPageSource().contains("Заявка на добровольное медицинское страхование"));

        //Заполнить поля данными
        String fieldXPath = "//input[@name='%s']";
        fillInputField(driver.findElement(By.xpath(String.format(fieldXPath, "LastName"))), "Фамилия");
        fillInputField(driver.findElement(By.xpath(String.format(fieldXPath, "FirstName"))), "Имя");
        fillInputField(driver.findElement(By.xpath(String.format(fieldXPath, "MiddleName"))), "Отчество");
        ...
        Assert.assertTrue("Сообщение об ошибке почты отсутсвует или изменилось", elementExist(By.xpath(errorEmailXPath)));
    }
